...
public class Display {
    ...
    public static void printUI(Player player) {
        ...
        System.out.print(attrNames[0] + ": " + player.maxHealth * 2 + "/" + player.attrNum[0] + "  ");
        System.out.print(attrNames[1] + ": " + player.maxEnergy * 5 / 2 + "/" + player.attrNum[1] + "  ");
        System.out.print(attrNames[2] + ": " + player.attrNum[2] + "  ");
        System.out.print(attrNames[3] + ": " + player.attrNum[3] + "  ");
        System.out.print(attrNames[4] + ": " + player.attrNum[4] + "  ");
        System.out.print(lang.getString("canInvisible") + ":" + player.canInvisible);
        System.out.println();
        for (int i = 0; i <= 2; ++i) {
            for (int j = 0; j <= 4; ++j) {
                System.out.print("|  " + eventName[player.map[i][j]] + "  ");
            }
            System.out.print("|\n");
        }
        System.out.println();
